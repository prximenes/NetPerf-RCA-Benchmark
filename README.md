...
## Resumo
Este repositório contém o NetPerf-RCA Benchmark (não confundir com a ferramenta netperf!), um conjunto de 24 cenários de falhas em redes e sistemas virtualizados destinado à avaliação de técnicas de diagnóstico automatizado, especialmente com modelos de linguagem.
